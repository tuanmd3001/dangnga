					...
					<div class="search search--location--mobile-header mobile-header__search">
						<div class="search__body">
							<form class="search__form" role="search" action="{{ route('shop.search.index') }}">
								<input class="search__input" name="term" placeholder="Tìm kiếm" aria-label="Site search" type="text" autocomplete="off">
				...
				<div class="nav-panel__container container">
					<div class="nav-panel__row">
						<div class="nav-panel__departments">
							<!-- .departments -->
							<div @if(Route::current()->getName() == 'shop.home.index')
