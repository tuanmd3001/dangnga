@if (Webkul\Product\Helpers\ProductType::hasVariants($product->type))
    ...
    @push('scripts')
        <script type="text/x-template" id="product-options-template">
            <div v-if="childAttributes.length > 0">
                <input
                    type="hidden"
                ...
                <div
                    ...
                    <div class="input-radio-label">
                        <div class="input-radio-label__list" v-for='(option, index) in attribute.options'>
                            <label>
                                <input type="radio" :value="option.id" :name="['super_attribute[' + option.id + ']']">
