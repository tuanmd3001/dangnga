<template>
    <div class="product-tabs">
        <div class="product-tabs__list">
            <a href="#tab-description" class="product-tabs__item product-tabs__item--active">{{ __('products.description') }}</a>
            <a href="#tab-specification" class="product-tabs__item">{{ __('products.specification') }}</a>
            <a href="#tab-reviews" class="product-tabs__item">{{ __('products.reviews') }}</a>
        </div>
        <div class="product-tabs__content">
            <div class="product-tabs__pane product-tabs__pane--active" id="tab-description">
                <div class="typography" v-html="info.description"></div>
            </div>
